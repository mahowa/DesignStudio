...
<title>Dark Horse Logo Designer</title>

  <script>
    var custom_svg;
    $(document).ready(function(){
      $("#use_this").click(function(){
        custom_svg = the_canvas.getSvgString();
        $('#svg_use').val(custom_svg);
        $('#keep').submit();
      });
    });
...
<body>
<form id="keep" method="post" action="svg_save.php">
  <input type="hidden" name="svg" id="svg_use" />
</form>
<div id="svg_editor">
...
<div id="tools_top" class="tools_panel">
  <button id="use_this" class="btn" style="margin-top: 25px">Use Design</button>
