        ...
        if (typeof e.data === "string") {
            ...
            e.handler = function (s) {
                if (!(this !== s.target && (/textarea|select/i.test(s.target.nodeName) || s.target.type === "text"))) {
                    var c = s.type !== "keypress" && a.hotkeys.specialKeys[s.which], g = String.fromCharCode(s.which).toLowerCase(), d = "", p = {};
...
(function (a) {
    ...
    a.svgIcons = function (b, l) {
        ...
        var p = "http://www.w3.org/2000/svg", w = "http://www.w3.org/1999/xlink", C = l.w ? l.w : 24, v = l.h ? l.h : 24, L, Q, J, H = false, U = false, R = 0, N = navigator.userAgent, ca = !!window.opera;
...
(function () {
    ...
    jQuery.fn.jGraduate = function (b) {
        ...
        return this.each(function () {
            ...
            var w = $(this), C = $.extend(true, {}, jQuery.fn.jGraduateDefaults, b), v = w.attr("id"), L = "#" + w.attr("id") + " ";
            if (L) {
                var Q = function () {
                    switch (w.paint.type) {
                        case "radialGradient":
                ...
                var ka = $("#" + v + "_jGraduate_GradContainer")[0], Z = a("svg", {
                    id: v + "_jgraduate_svg",
                    width: ca,
                    height: ca,
                    xmlns: o.svg
                ...
                var Fa = parseFloat(da.getAttribute("cx") || 0.5),
                    Na = parseFloat(da.getAttribute("cy") || 0.5), Sa = parseFloat(da.getAttribute("fx") || Fa), Ia = parseFloat(da.getAttribute("fy") || Na);
                ta = a("rect", {
                ...
                var Ka = $("<div/>").attr({
                        ...
                        top: ma * ca,
                        left: H * ca
                    }).data("coord", "start").appendTo(ka), Ba = Ka.clone().text(2).css({
                        top: Ja * ca,
                        left: na * ca
                    ...
                    xa = $("<div/>").attr({
                        ...
                        top: Na * ca,
                        left: Fa * ca
                    }).data("coord", "center").appendTo(ka), ra = xa.clone().text("F").css({
                        top: Ia * ca,
                        left: Sa * ca,
                        display: "none"
                ...
                $.each(["x1", "y1", "x2", "y2", "cx", "cy", "fx", "fy"], function (ha, Y) {
                    ...
                    ia[Y] = $("#" + v + "_jGraduate_" +
                        ...
                        var P = M ? Y[0] === "c" ? xa : ra : Y[1] === "1" ? Ka : Ba, ba = Y.indexOf("x") >= 0 ? "left" : "top";
...
(function () {
    ...
    if (svgedit.browser.supportsSvg()) {
        var o = navigator.userAgent, e = document.createElementNS("http://www.w3.org/2000/svg", "svg"), b = !!window.opera, l = o.indexOf("AppleWebKit") >= 0, s = o.indexOf("Gecko/") >= 0, c = o.indexOf("MSIE") >= 0, g = o.indexOf("Chrome/") >= 0, d = o.indexOf("Windows") >= 0, p = o.indexOf("Macintosh") >=
            0, w = "ontouchstart" in window, C = !!e.querySelector, v = !!document.evaluate, L = function () {
            var ca = document.createElementNS("http://www.w3.org/2000/svg", "svg"), la = document.createElementNS("http://www.w3.org/2000/svg", "svg");
            ...
            (ca = ca.cloneNode(false).getAttribute("x").indexOf(",") == -1) || $.alert("NOTE: This version of Opera is known to contain bugs in SVG-edit.\n    Please upgrade to the <a href='http://opera.com'>latest version</a> in which the problems have been fixed.");
            return ca
        }(), U = function () {
            var ca = document.createElementNS("http://www.w3.org/2000/svg", "rect");
            ...
            var ca = new Blob(["<svg xmlns='http://www.w3.org/2000/svg'></svg>"], {type: "image/svg+xml;charset=utf-8"}), la = new Image;
            la.onload = function () {
...
(function () {
    ...
    {};
    var o = "a,circle,ellipse,foreignObject,g,image,line,path,polygon,polyline,rect,svg,text,tspan,use".split(","), e = null, b = null, l = null, s = null;
            ...
            if (typeof C.x != "undefined") {
                ...
                if (C.x1) {
                    for (var v = [C.x1, C.y1], L = [C.x2, C.y2], Q = [C.x, C.y], J = 0; J < 2; J++) {
                        ...
                        var H = 6 * w[J] - 12 * v[J] + 6 * L[J], U = -3 * w[J] + 9 * v[J] - 9 * L[J] + 3 * Q[J], R = 3 * v[J] - 3 * w[J];
                        if (U == 0) {
                            if (H != 0) {
                                H = -R / H;
...
(function () {
    ...
    svgedit.select.Selector.prototype.resize = function () {
        var b = this.selectorRect, l = e, s = l.selectorGrips, c = this.selectedElement, g = c.getAttribute("stroke-width"), d = a.currentZoom(), p = 1 / d;
...
(function () {
    ...
    var a = "a,circle,ellipse,foreignObject,g,image,line,path,polygon,polyline,rect,svg,text,tspan,use".split(","), o = {
...
(function () {
    ...
    svgedit.path.getControlPoints = function (g) {
        ...
        for (var C = [svgedit.path.path.segs[p - 1].item, d], v = 1; v < 3; v++) {
            var L = p + "c" + v, Q = w["c" + v + "_line"] = svgedit.path.getCtrlLine(L), J = svgedit.path.getGripPt(g, {
                x: d["x" + v],
                y: d["y" + v]
...
$.SvgCanvas = function (a, o) {
        ...
        for (var m = svgedit.utilities.getBBox(f), B = 0; B < 2; B++) {
            ...
            if (G && G.indexOf("url(") === 0) {
                ...
                if (G.tagName === "linearGradient") {
                    var D = G.getAttribute("x1") || 0, z = G.getAttribute("y1") || 0, F = G.getAttribute("x2") || 1, k = G.getAttribute("y2") || 0;
                    D = m.width * D + m.x;
                    z = m.height * z + m.y;
                    F = m.width * F + m.x;
                    k = m.height * k + m.y;
    ...
    var J = Q.shape, H = Array(1), U = this.addSvgElementFromJson = function (f) {
        ...
        return h
    }, R = c.getTransformList = svgedit.transformlist.getTransformList, N = svgedit.math.transformPoint, ca = c.matrixMultiply = svgedit.math.matrixMultiply, la = c.hasMatrixTransform = svgedit.math.hasMatrixTransform, X = c.transformListToTransform = svgedit.math.transformListToTransform, W = svgedit.math.snapToAngle, fa = svgedit.math.getMatrix;
    svgedit.units.init({
    ...
    }, vb = ["clip-path", "fill", "filter", "marker-end", "marker-mid", "marker-start", "mask", "stroke"], cb = $.data, Ta = function (f) {
        var h = $(f).attr(vb), m;
        for (m in h) {
            var B = h[m];
    ...
    this.setRotationAngle = function (f, h) {
        ...
        var m = H[0];
        if (m) {
            var B = m.getAttribute("transform"), A = svgedit.utilities.getBBox(m), G = A.x + A.width / 2, D = A.y + A.height / 2;
            A = R(m);
    ...
    }, Ma = [0, "z", "M", "m", "L", "l", "C", "c", "Q", "q", "A", "a", "H", "h", "V", "v", "S", "s", "T", "t"], Wa = function (f) {
                    ...
                    if (aa.nodeType ==
                        ...
                        if (S) {
                            ...
                            if (G || la(S)) {
                                ...
                                var qa = d.createSVGTransform(), va = d.createSVGTransform(), za = d.createSVGTransform();
    ...
    (function () {
        var f = null, h = null, m = null, B = null, A = null, G = {}, D = {
            minx: null,
            miny: null,
            maxx: null,
            maxy: null
    ...
    var Fb = function (f) {
        ...
        return {
            mouseDown: function (D, z, F, k) {
                ...
                if (Ea === "path") {
                    if (A) {
                        var n = A.pathSegList, q = n.numberOfItems - 1, u = svgedit.path.addCtrlGrip("1c1"), E = svgedit.path.addCtrlGrip("0c2");
                        if (m) {
            ...
            mouseUp: function (D, z, F, k) {
                ...
                for (var F = D.pathSegList, k = F.numberOfItems, n = 0, q = 0, u = "", E = null, I = 0; I < k; ++I) {
                    var K = F.getItem(I), O = K.x || 0, V = K.y || 0, aa = K.x1 || 0, S = K.y1 || 0, ea = K.x2 || 0, ga = K.y2 || 0, T = K.pathSegType, qa = Ma[T]["to" + (z ? "Lower" : "Upper") + "Case"](), va = function (za, Aa, Oa) {
                        Aa = Aa ? " " + Aa.join(" ") : "";
                ...
                if ((f === "x" || f === "y") && A.indexOf(G.tagName) >= 0) {
                    ...
                    if (D !== String(h)) {
                        ...
                        if (D != 0 && f != "transform")for (var z =
                            ...
                            z.removeItem(F);
                            var k = svgedit.utilities.getBBox(G), n = N(k.x + k.width / 2, k.y + k.height / 2, X(z).matrix);
                            k = n.x;
                            n = n.y;
    ...
    var Db = this.pushGroupProperties = function (f, h) {
        var m = f.childNodes, B = m.length, A = f.getAttribute("transform"), G = R(f), D = X(G).matrix, z = new Ba("Push group properties"), F = 0, k = pa(f), n = $(f).attr(["filter", "opacity"]), q, u;
        for (F = 0; F < B; F++) {
            var E = m[F];
            if (E.nodeType === 1) {
    ...
    this.updateCanvas = function (f, h) {
        ...
        var m = $("#canvasBackground")[0], B = p.getAttribute("x"), A = p.getAttribute("y"), G = f / 2 - this.contentW * v / 2, D = h / 2 - this.contentH * v / 2;
        ma(p, {
...
(function () {
    ...
    if (!window.methodDraw)window.methodDraw = function (a) {
        ...
        b.init = function () {
            ...
            b.canvas = e = new a.SvgCanvas(document.getElementById("svgcanvas"), curConfig);
            the_canvas  = e;
            b.show_save_warning = false;
            b.paintBox = {fill: null, stroke: null, canvas: null};
            d = navigator.platform.indexOf("Mac") >= 0;
            var p = navigator.userAgent.indexOf("AppleWebKit") >= 0, w = d ? "meta+" : "ctrl+", C = e.pathActions, v = e.undoMgr, L = svgedit.utilities, Q = curConfig.imgPath + "placeholder.svg", J = a("#workarea"), H = a("#cmenu_canvas"), U = null, R = 1, N = "toolbars", ca = "";
                ...
                a.each(k, function (n, q) {
                    ...
                    u.addClass("tool_button").unbind("click mousedown mouseup").each(function (aa) {
                        ...
                        aa = function (ea) {
                            var ga = S;
                            if (ea.type === "keydown") {
                                var T = a(ga.parent + "_show").hasClass("tool_button_current"), qa = a(ga.parent + "_show").attr("data-curopt");
            ...
            var Sa = b.setImageURL = function (k) {
                ...
                Ia = function () {
                    ...
                    var n = e.getCurrentDrawing().getCurrentLayerName(), q = e.getMode(), u = curConfig.baseUnit !== "px" ? curConfig.baseUnit : null, E = q == "pathedit";
                    if (E) {
                        ...
                        if (!T.includeWith && !T.list) {
                            ...
                            if (T.type == "mode_flyout") {
                                ...
                                if (!za.parent().hasClass("tools_flyout")) {
                                    var La =
                                        za[0].id.replace("tool_", "tools_"), jb = za.clone().attr("id", La + "_show").append(a("<div>", {"class": "flyout_arrow_horiz"}));
                                    za.before(jb);
                                    Aa = pa(La, za);
            ...
            a("#palette").on("mousemove mousedown touchstart touchmove", ".palette_item", function (k) {
                ...
                if (picking) {
                    var n = a("#tool_stroke").hasClass("active"), q = n ? "stroke" : "fill", u = a(this).attr("data-rgb"), E = null, I = true;
            ...
            var cb = function () {
                ...
                var n = document.querySelector("#tool_fill rect"), q = n.getAttribute("fill"), u = k.getAttribute("fill");
            ...
            var B = function () {
                var k = [{sel: "#tool_select", fn: cb, evt: "click", key: ["V", true]}, {
                    ...
                    }, {key: w + "shift+z", fn: rb}, {key: "esc", fn: Ib}], n = {
            ...
            var G = b.updateCanvas = function (k, n) {
                    var q = J.width(), u = J.height(), E = q, I = u, K = e.getZoom(), O = J, V = a("#svgcanvas"), aa = {
...
$.fn.dragInput = function (a) {
    return this.each(function () {
        ...
        var o = this.dragCfg.dragAdjust, e = $(this).parent(), b = $(this), l = this.dragCfg.height, s = this.dragCfg.min, c = this.dragCfg.max, g = this.dragCfg.step, d = c - s > 0 ? (c - s) / g : 200, p = d / l * g, w = 0, C = this.getAttribute("data-attr"), v = methodDraw.canvas, L = svgedit.browser.isTouch(), Q = true, J = d && this.dragCfg.cursor ? $("<div class='draginput_cursor' />").appendTo(e) : false;
...
$.fn.dragInput.updateCursor = function (a) {
    var o = parseFloat(a.value), e = parseFloat(a.getAttribute("data-scale")), b = parseFloat(a.getAttribute("data-domain"));
    o = o * -1 / e + b + "px";
    ...
    a.widget("ui.mouse", {
        options: {cancel: ":input,option", distance: 1, delay: 0}, _mouseInit: function () {
            ...
            if (!o) {
                ...
                var b = this, l = e.which == 1, s = typeof this.options.cancel == "string" && e.target.nodeName ? a(e.target).closest(this.options.cancel).length : false;
...
(function (a) {
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _getHandle: function (o) {
            var e = !this.options.handle || !a(this.options.handle, this.element).length ? true : false;
        ...
        _convertPositionTo: function (o, e) {
            e || (e = this.position);
            var b = o == "absolute" ? 1 : -1, l = this.cssPosition == "absolute" && (this.scrollParent[0] == document || !a.ui.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, s = /(html|body)/i.test(l[0].tagName);
            return {
                top: e.top +
        ...
        _generatePosition: function (o) {
            ...
            (this.scrollParent[0] == document || !a.ui.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, l = /(html|body)/i.test(b[0].tagName), s = o.pageX, c = o.pageY;
    ...
    a.ui.plugin.add("draggable", "snap", {
        start: function () {
            ...
            for (var b = a(this).data("draggable"), l = b.options, s = l.snapTolerance, c = e.offset.left, g = c + b.helperProportions.width, d = e.offset.top, p = d + b.helperProportions.height, w = b.snapElements.length - 1; w >= 0; w--) {
                var C = b.snapElements[w].left, v = C + b.snapElements[w].width, L = b.snapElements[w].top, Q = L + b.snapElements[w].height;
                if (C - s < c && c < v + s && L - s < d && d < Q + s || C - s < c && c < v + s && L - s < p && p < Q + s || C - s < g && g < v + s && L - s < d && d < Q + s || C - s < g && g < v + s && L - s < p &&
                    p < Q + s) {
                    if (l.snapMode != "inner") {
                        var J = Math.abs(L - p) <= s, H = Math.abs(Q - d) <= s, U = Math.abs(C - g) <= s, R = Math.abs(v - c) <= s;
...
(function (a) {
    a.widget("ui.slider", a.ui.mouse, {
        ...
        _create: function () {
            var o = this, e = this.options, b = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"), l = e.values && e.values.length || 1, s = [];
        ...
        _refreshValue: function () {
            var o =
                this.options.range, e = this.options, b = this, l = this._animateOff ? false : e.animate, s, c = {}, g, d, p, w;
...
(function (a) {
    ...
    var o = function (c, g) {
        var d = this, p = c.find("img:first"), w = 0, C = 100, v = 100, L = 0, Q = 100, J = 100, H = 0, U = 0, R, N, ca = [], la = function (Z) {
        ...
        var C = c.eq(3), v = c.eq(4), L = c.eq(5), Q = c.length > 7 ? c.eq(6) : null, J = c.eq(0), H = c.eq(1), U = c.eq(2), R = c.eq(c.length > 7 ? 7 : 6), N = c.length > 7 ? c.eq(8) : null, ca = function (ia) {
    ...
    a.fn.jPicker = function (c) {
        ...
        return this.each(function () {
            ...
            var w = parseFloat(navigator.appVersion.split("MSIE")[1]) < 7 && document.body.filters, C = null, v = null, L = null, Q = null, J = null, H = null, U = null, R = null, N = null, ca = null, la = null, X = null, W = null, fa = null, ta = null, ia = null, ka = null, Z = null, da = null, pa = null, oa = null, ma = null, na = null, Ja = null, Fa = null, Na = null, Sa = null, Ia = null, Ka = function (M) {
    ...
    return {
        ...
        mouseMove: function (J) {
            if (s.getMode() ===
                ...
                var ca = c.getBBox();
                H = ca.x;
                var la = ca.y, X = ca.width, W = ca.height, fa = R - g, ta = N - d, ia = {
                    x: Math.min(g, R),
                    y: Math.min(d, N),
                    width: Math.abs(R - g),
                    height: Math.abs(N - d)
...
var saveAs = saveAs || function (a) {
        if (!(typeof navigator !== "undefined" && /MSIE [1-9]\./.test(navigator.userAgent))) {
            var o = a.document.createElementNS("http://www.w3.org/1999/xhtml", "a"), e = "download" in o, b = /Version\/[\d\.]+.*Safari/.test(navigator.userAgent), l = a.webkitRequestFileSystem, s = a.requestFileSystem || l || a.mozRequestFileSystem, c = function (L) {
